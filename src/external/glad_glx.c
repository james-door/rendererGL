/*
    ...
    GLX loader generated by glad 0.1.36 on Thu Mar  6 05:34:09 2025.
    ...
    Commandline:
        --api="glx=1.4" --generator="c" --spec="glx" --extensions="GLX_ARB_create_context,GLX_ARB_create_context_profile"
    Online:
